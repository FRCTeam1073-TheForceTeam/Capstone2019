...
public class ControlledMotorAnalog extends ControlledMotor {
     ...
     */
    public ControlledMotorAnalog(CANSparkMax motor_, int axis_) {
     ...
     * @param axis_ The axis on the selected controller to be mapped to motor output.
     */
    public ControlledMotorAnalog(CANSparkMax motor_, int axis_, double scale_) {
     ...
     * @param axis_ The axis on the selected controller to be mapped to motor output.
     */
    public ControlledMotorAnalog(CANSparkMax motor_, XboxController controller_, int axis_) {
     ...
     */
    public ControlledMotorAnalog(CANSparkMax motor_, XboxController controller_, int axis_, double scale_,boolean deadzone_) {
        motor = motor_;
        axis = axis_;
