...
public class ControlledMotorDigital extends ControlledMotor {
     ...
     */
    public ControlledMotorDigital(CANSparkMax motor_, XboxController controller_, JoystickButton button_) {
     ...
     */
    public ControlledMotorDigital(CANSparkMax motor_, XboxController controller_, JoystickButton button_, double off, double on) {
        motor = motor_;
